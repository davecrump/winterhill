...
wget --timeout=2 https://raw.githubusercontent.com/${GIT_SRC}/winterhill/master/scripts/latest_version.txt
...
then                     ## then check the internet connection
  ...
  then
    ...
    printf "Try connecting to: \n\nhttps://raw.githubusercontent.com/BritishAmateurTelevisionClub/winterhill/master/scripts/latest_version.txt\n\n"
...
then
    ...
    if [[ "$REPLY" = "y" || "$REPLY" = "Y" ]]; then  ## Force upgrade requested
        ...
        wget https://raw.githubusercontent.com/BritishAmateurTelevisionClub/winterhill/master/update.sh
        chmod +x update.sh
        /home/pi/update.sh -p
        exit
        ...
        cd /home/pi
        rm update.sh >/dev/null 2>/dev/null
        wget https://raw.githubusercontent.com/davecrump/winterhill/master/update.sh
        chmod +x update.sh
        /home/pi/update.sh -d
        exit
