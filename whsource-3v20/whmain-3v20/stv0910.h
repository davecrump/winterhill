...
*/
	...
	#define KHZ22OFF								2		// write to NIM_A registers Px_DISTXCFG
	#define KHZ22ON									0		// P1 for VGX, P2 for VGY

	#define STV_TUNER1_DEMOD2						1		// the paths are crossed in the NIM
	#define STV_TUNER2_DEMOD1						2
	...
	uint8_t stv0910_read_multistream0 				(uint8_t, uint32_t*) ;				
	uint8_t stv0910_read_multistream1 				(uint8_t, uint32_t*) ;				
	uint8_t stv0910_read_debug0 					(uint8_t, uint32_t*) ;						
	uint8_t stv0910_read_debug1 					(uint8_t, uint32_t*) ;						
	uint8_t stv0910_read_matstr1					(uint8_t, uint8_t*) ;						
	uint8_t stv0910_read_pdelctrl1					(uint8_t, uint8_t*) ;						
	uint8_t stv0910_write_pdelctrl1					(uint8_t, uint8_t) ;						
	uint8_t stv0910_write_isibitena					(uint8_t, uint8_t) ;						
	uint8_t stv0910_write_isientry					(uint8_t, uint8_t) ;						

	uint8_t stv0910_read_car_freq					(uint8_t, int32_t*);
	uint8_t stv0910_read_constellation				(uint8_t, uint8_t*, uint8_t*);
	uint8_t stv0910_read_sr							(uint8_t, uint32_t*);
	...
	uint8_t stv0910_read_dvbs2_mer					(uint8_t, int32_t*);
	uint8_t stv0910_read_errors_bch_uncorrected		(uint8_t, bool*);
	uint8_t stv0910_read_errors_bch_count			(uint8_t, uint32_t*);
	uint8_t stv0910_read_errors_ldpc_count			(uint8_t, uint32_t*);
	uint8_t stv0910_read_mer						(uint8_t, int32_t*);
	uint8_t stv0910_read_modcod_and_type			(uint8_t, uint32_t*, bool*, bool*);
	uint8_t stv0910_read_rolloff					(uint8_t, uint32_t*) ;
	uint8_t stv0910_init							(void) ;
	uint8_t stv0910_setup_receive					(uint32_t, uint32_t, int32_t);
	uint8_t stv0910_init_regs						(void);
	uint8_t stv0910_setup_timing_loop				(uint8_t, uint32_t);
	uint8_t stv0910_setup_carrier_loop				(uint8_t, uint32_t, uint32_t); 
