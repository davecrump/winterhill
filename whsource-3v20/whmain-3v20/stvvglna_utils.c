...
uint8_t stvvglna_read_reg(uint8_t xlna_addr, uint8_t reg, uint8_t *val) 
{
    return nim_read_xlna (xlna_addr, reg, val);
}
...
uint8_t stvvglna_write_reg (uint8_t xlna_addr, uint8_t reg, uint8_t val) 
{
    return nim_write_xlna (xlna_addr, reg, val);
}
